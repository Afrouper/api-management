...
openssl req -new -sha256 -key ca.key -out ca.csr -config openssl_ca.cnf
openssl x509 -req -days 1024 -sha256 -extensions v3_ca -signkey ca.key -in ca.csr -out ca.crt
#openssl req -x509 -new -key ca.key -sha256 -days 1024 -out ca.crt -extensions v3_ca
rm ca.csr
